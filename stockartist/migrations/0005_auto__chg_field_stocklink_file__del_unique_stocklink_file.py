...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'StockLink', fields ['file']
        db.delete_unique(u'stockartist_stocklink', ['file_id'])


        # Changing field 'StockLink.file'
        db.alter_column(u'stockartist_stocklink', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.File']))

    def backwards(self, orm):

        # Changing field 'StockLink.file'
        db.alter_column(u'stockartist_stocklink', 'file_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, to=orm['filer.File'], unique=True))
        # Adding unique constraint on 'StockLink', fields ['file']
        db.create_unique(u'stockartist_stocklink', ['file_id'])
