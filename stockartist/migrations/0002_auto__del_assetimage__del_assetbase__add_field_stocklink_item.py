...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StockLink.item'
        db.add_column(u'stockartist_stocklink', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='item_set', to=orm['filersets.Item']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'stockartist_assetimage', (
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='image_set', null=True, to=orm['filer.Image'], blank=True)),
        ...
        db.create_table(u'stockartist_assetbase', (
            ...
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='file_set', null=True, to=orm['filer.File'], blank=True)),
        ...
        # Deleting field 'StockLink.item'
        db.delete_column(u'stockartist_stocklink', 'item_id')
    ...
    models = {
        ...
        u'stockartist.stocklink': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'item_set'", 'to': u"orm['filersets.Item']"}),
