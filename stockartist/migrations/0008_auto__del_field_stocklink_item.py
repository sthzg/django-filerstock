...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'StockLink.item'
        raise RuntimeError("Cannot reverse this migration. 'StockLink.item' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'StockLink.item'
        db.add_column(u'stockartist_stocklink', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='item_stocklinks', to=orm['filersets.Item']),
                      keep_default=False)
    ...
    models = {
        ...
        u'stockartist.stocklink': {
            ...
            'file': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'file_stocklinks'", 'to': "orm['filer.File']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
