...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StockLink.file'
        db.add_column(u'stockartist_stocklink', 'file',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='file_stocklinks', null=True, default=None, to=orm['filer.File'], blank=True, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StockLink.file'
        db.delete_column(u'stockartist_stocklink', 'file_id')
    ...
    models = {
        ...
        u'stockartist.stocklink': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'file': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'file_stocklinks'", 'null': 'True', 'default': 'None', 'to': "orm['filer.File']", 'blank': 'True', 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
